...
data0830 <- read_xlsx("2022-08-30_TSV qPCR sample eval_Results_QuantStudio 12K Flex_export.xlsx", col_names = T,range = "A33:Y250")

data0901 <- read_xlsx("2022-09_01_TSV qPCR sample eval-1_Results_QuantStudio 12K Flex_export.xlsx", col_names = T,range = "A36:Y250")

data0912 <- read_xlsx("2022-09_12_TSV qPCR sample eval-3_Results_QuantStudio 12K Flex_export.xlsx", col_names = T,range = "A33:Y250")

data0913 <- read_xlsx("2022-09_13_TSV qPCR sample eval-4_Results_QuantStudio 12K Flex_export.xlsx", col_names = T,range = "A33:Y250")
...
QS_data_filtered_summ <- QS_data_filtered%>% group_by(date,`Sample Name`) %>% summarise(mean_CT = mean(CT), sd_CT = sd(CT), mean_log10cp = mean(log10cp), sd_log10cp = sd(log10cp), mean_copies = mean(10^log10cp),sd_copies = sd(10^log10cp))
```
...
qPCR_dil_data <- read_xlsx("../TSV_dil_data.xlsx", sheet = "SRM_qPCR")
...
write.csv(QS_data_filtered_summ_val, "TSV_qPCR_SRM.csv", quote = F, row.names = F)
