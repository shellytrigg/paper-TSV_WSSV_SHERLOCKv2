...
plot LAMP data
```{r}
jpeg("../Supplemental_Material/Supp_figs/FigS1_LAMP_screen.jpg", width = 10, height = 5, units = "in", res = 300)
...
c <- ggplot(WSSV_lamp_data2, aes(x = minutes, y = rel_rfus, color = factor(copies), group= Well))+ geom_point(size = 0.8) + geom_line() + theme_bw() + labs(y = "relative RFUs", x = "minutes", color = "WSSV copies") + facet_wrap(~primer_set, ncol = 4)
