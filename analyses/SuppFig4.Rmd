...
```{r}
jpeg("../Supplemental_Material/Supp_figs/FigS4b_WSSV_OnePot_relRFU_facets_dye.jpg",width = 20, height =6, units = "in", res = 300 )
...
jpeg("../Supplemental_Material/Supp_figs/FigS4a_TSV_OnePot_relRFU_facets_dye.jpg",width = 20, height =6, units = "in", res = 300 )
